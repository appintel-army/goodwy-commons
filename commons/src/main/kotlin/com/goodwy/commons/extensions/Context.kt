...
fun Context.isDefaultDialer(): Boolean {
    return if (!packageName.startsWith("com.goodwy.contacts") && !packageName.startsWith("com.myoscontacts.dialer")) {
        true
    } else if ((packageName.startsWith("com.goodwy.contacts") || packageName.startsWith("com.myoscontacts.dialer")) && isQPlus()) {
...
fun Context.isCollection(): Boolean {
    return isPackageInstalled("com.myoscontacts.dialer")
